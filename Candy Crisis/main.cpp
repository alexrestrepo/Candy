...
//
// FEATURES:
// ¥ Runs natively on SDL 2.0 and Intel OS X. Targeting modern OS X, circa 2015 (e.g. OS X 10.10).
//
// ETC:
// ¥ÊRemoved registration.
// ¥ÊResources moved into app bundle.
// ¥ Migrated to SDL 2 and SDL_image 2 (for graphics--also removes subdependencies on libjpeg/libpng)
//
...
//    SDL_CreateWindowAndRenderer(640, 480, 0, &g_window, &g_renderer);
    ...
    g_frontSurface = SDL_CreateRGBSurface(0, 640, 480, 16,
                                           0x7C00,
                                           0x03E0,
                                           0x001F,
                                           0x0000);
